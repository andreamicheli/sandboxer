...
class LocalKvmRunnerProvider:
    ...
    def _capture_serial_stages(self, records: list[_RunnerRecord]) -> None:
        ...
        allowed = {
            ...
            "SANDBOXER_CONTROL_FAILED", "SANDBOXER_TOY_ROOT_MISSING", "SANDBOXER_TOY_LAUNCH_FAILED",
            "SANDBOXER_TOY_LISTENER_MISSING", "SANDBOXER_TOY_ROOT_FAILED", "SANDBOXER_TOY_EXEC_FAILED",
            "SANDBOXER_TOY_BIND_FAILED", "SANDBOXER_TOY_ADDRESS_UNAVAILABLE", "SANDBOXER_TOY_HTTPD_BIND_EXIT",
            "SANDBOXER_HTTPD_ERROR_BIND", "SANDBOXER_HTTPD_ERROR_PRIVILEGE",
            "SANDBOXER_HTTPD_ERROR_DOCUMENT_ROOT", "SANDBOXER_HTTPD_ERROR_OTHER",
            "SANDBOXER_TOY_EXITED_OTHER", "SANDBOXER_TOY_READY",
